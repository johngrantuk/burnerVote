...
import AwesomeQRCode from "../awesome-qr/awesome-qr";
      ...
      <div>
        ...
        <Row>
          <Col className="col-sm">
            ...
            <div>
              <div style={{textAlign: 'center', backgroundColor: 'white'}}>
                <ReactQr text={this.props.proposal.optionAaddr} size={300} dotScale={0.4}/>
              </div>
            </div>
          ...
          <Col className="col-sm">
            ...
            <div>
              <div style={{textAlign: 'center', backgroundColor: 'white'}}>
                <ReactQr text={this.props.proposal.optionBaddr} size={300} dotScale={0.4}/>
              </div>
            </div>
